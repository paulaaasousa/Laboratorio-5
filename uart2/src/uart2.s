...
main:   MOV R2, #(UART0_BIT)
	...
	LDR R0, =UART_PORT0_BASE
        BL UART_config ; configura periférico UART0T
...
wrx:    LDR R2, [R0, #UART_FR] ; status da UART
       ...
       LDR R2, = SISMIC ;String constant
       MOVS R3, #0x1B   ;string constant size
...
UART_config:
        ...
        MOV R1, #01101110b ;; bit de paridade par habilitado, 8 Bits, 2 stop bits, 
        STR R1, [R0, #UART_LCRH]
...
Button1_int_clear:
        ...
        DATA
SISMIC  DC8  "Sistemas Microcontrolados\r\n"
